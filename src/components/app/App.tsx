            ...
            <div className="inputs-group">
              <div className="input">
                ...
                <div className="input__wrapper">
                  <input type="text" id="age" name="age" placeholder="0" inputMode="decimal" required />
                </div>
              </div>
              <div className="input">
                <div className="input__heading">
                ...
                <div className="input__wrapper">
                  <input type="text" id="height" name="height" placeholder="0" inputMode="decimal" required />
                </div>
              </div>
              <div className="input">
                <div className="input__heading">
                ...
                <div className="input__wrapper">
                  <input type="text" id="weight" name="weight" placeholder="0" inputMode="decimal" required />
                </div>
              </div>
            </div>
          </fieldset>
